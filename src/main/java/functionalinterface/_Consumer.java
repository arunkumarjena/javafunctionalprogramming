...
public class _Consumer {
    public static void main(String[] args) {
        // Normal Function
        Customer regular= new Customer("Arun","7682068818");
        System.out.println(regular);

        // Calling Consumer function
       greetCustomerConsumer.accept(regular);
       greetCustomerConsumerV2.accept(regular,false);

       greetCustomerV2(regular,true);
    }
